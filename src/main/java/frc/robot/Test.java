...
public class Test {
    ...
    public void testDriveTrain() {
        if (Objects.operatorJoy.getRawButton(ControllerMap.R_BUMPER)) {
            Motors.leftBack.set(-Objects.operatorJoy.getRawAxis(ControllerMap.L_STICKY));
            Motors.leftFront.set(-Objects.operatorJoy.getRawAxis(ControllerMap.L_STICKY));
            Motors.rightBack.set(Objects.operatorJoy.getRawAxis(ControllerMap.R_STICKY));
            Motors.rightFront.set(Objects.operatorJoy.getRawAxis(ControllerMap.R_STICKY));  
        } else {
